...
import GovAdminSettings from "./pages/gov/AdminSettings";
import GovApplicationReview from "./pages/gov/ApplicationReview";
import GovAuditCompliance from "./pages/gov/AuditCompliance";
import GovDashboard from "./pages/gov/Dashboard";
import GovDisbursements from "./pages/gov/Disbursements";
import GovReportsAnalytics from "./pages/gov/ReportsAnalytics";
import GovernmentFunds from "./pages/GovernmentFunds";
...
import SubsidyRegistration from "./pages/SubsidyRegistration";
        ...
        <div className="fixed left-0 top-16 z-50 w-full md:w-[760px] lg:w-[900px]">
          <div className="mx-0 rounded-b-xl border bg-card shadow-2xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 p-4">
              <Link to="/public-dashboard" onClick={() => setFeaturesOpen(false)} className="flex items-center gap-3 rounded-md p-3 hover:bg-accent/50">
              ...
              <Link to="/government-funds" onClick={() => setFeaturesOpen(false)} className="flex items-center gap-3 rounded-md p-3 hover:bg-accent/50">
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/subsidy-registration" element={<SubsidyRegistration />} />
          ...
          <Route path="/gov/review/:id" element={<GovApplicationReview />} />
          <Route path="/gov/disbursements" element={<GovDisbursements />} />
          <Route path="/gov/audit" element={<GovAuditCompliance />} />
          <Route path="/gov/reports" element={<GovReportsAnalytics />} />
          <Route path="/gov/settings" element={<GovAdminSettings />} />
